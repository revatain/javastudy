...
public class WhileTest01 {
	public static void main(String[] args) {
		...
		while (destination!=car){ //desticantion과 car가 같지 않으면 계속 수행
			car = car + speed;
			i++;
		} //while문이 한번 돌때 마다 3초가 지나는 것입니다. 20번 돌면 1분이 지나겠죠?
		System.out.println(i+"번"); //3758번 while문을 수행했습니다. 분으로 환산해 보겠습니다.
		int min = i/20;
		System.out.println(min+"분"); //187분이 걸렸네요. 시간으로 환산해보겠습니다.
		int hour = min/60; 
		System.out.println(hour+"시간"); //7분이 출력되지 않았네요.int는 정수형이라서 소수점이 나오지 않습니다.
